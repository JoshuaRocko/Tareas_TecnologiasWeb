...
public class Archivos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("Elige una canción: <input list=\"canciones\" name=\"cancion\" />");
        out.println("<datalist id=\"canciones\">");
        if(!nombres.isEmpty()){
            for(String cancion : nombres){
                out.println("<option value='"+cancion+"'>");
            }
        }
